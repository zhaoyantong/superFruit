<template>
  <div class="addFruit">
    <el-form class="detail-form" autocomplete="on" :model="fruitForm" :rules="fruitRules" ref="fruitForm"
      label-position="left" label-width="100px">
      <div class="bread">
        <span class="btn" @click="returnPage">商品管理</span>
        <span class="line"> >> </span>
        <span class="btn1">商品上传</span>
      </div>
      <el-row>
        <el-col :span="8">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item prop="fruitWeight" label="商品标签">
      ...
      <div class="dialog-footer" style="float:right;margin-right: 212px;">
        ...
        <el-button @click="addFruit" :disabled="isDisabled">保存</el-button>
      </div>
    </el-form>
  </div>
</template>
      ...
      addFruit() {
        this.$refs.fruitForm.validate(valid => {
          ...
          if (valid) {
            ...
            formData.append("fruitPicture",this.fruitPictureUrl[0] ? this.fruitPictureUrl[0].raw : '');//首页图片
